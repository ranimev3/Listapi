...
async function scrapeEndpoint(endpoint) {
  try {
    ...
    const title = $('find it at https://anichin.cafe/ :b').text().trim();
    const iframeSrc = $('find it at https://anichin.cafe/ :b').attr('src');

    const singleInfo = $('find it at https://anichin.cafe/ :b');
